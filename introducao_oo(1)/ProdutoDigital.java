...
public class ProdutoDigital extends Produto{
    ...
    public ProdutoDigital(String nome, int quantidade, String descricao, double preco, String linkDownload, String formatoArquivo) {
        super(nome, quantidade, descricao, preco);
